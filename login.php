...
<html lang="en">
    <head>
        ...
        <title>Sistem Rekomendasi Mahasiswa Berpotensi Lulus Tepat Waktu Metode SMART</title>
    ...
    <div class="row d-plex justify-content-between mt-5">				
        <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
            <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                <div class="text-justify card-body p-1">
                    <h4 style="font-weight: 800;"> Sistem Rekomendasi Mahasiswa Berpotensi Lulus Tepat Waktu Metode SMART</h4>
                    <!-- <img src="./assets/img/gambar-kampus.jpg" alt="Gambar Penjelasan Sistem" class="img-fluid pt-4"> -->
                    <img src="./assets/img/vector-kampus.png" alt="Gambar Penjelasan Metode SMART" class="img-fluid">
                </div>
            </div>
        </div>
