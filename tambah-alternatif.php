...
$id_user = $_SESSION['user_id'];  // Assuming you're storing the logged-in user's id in the session
...
if (isset($_POST['submit'])):
    ...
    if (empty($errors)):
        // Menyimpan data alternatif dengan id_user yang sekarang
        $simpan = mysqli_query($koneksi, "INSERT INTO alternatif (id_alternatif, nama, id_user) VALUES ('', '$nama', '$id_user')");
        if ($simpan) {
