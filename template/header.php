...
<head>
  ...
  <title>Sistem Rekomendasi Mahasiswa UAD Berpotensi Lulus Tepat Waktu</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-orange sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      ?>
        ...
        <li class="nav-item <?php if ($page == "Perhitungan_user") {
                              echo "active";
                            } ?>">
          <a class="nav-link" href="Perhitungan_user.php">
            <i class="fas fa-fw fa-calculator"></i>
            <span>Data Perhitungan User</span></a>
        </li>

        <li class="nav-item <?php if ($page == "Hasil") {
                              echo "active";
                            } ?>">
          <a class="nav-link" href="hasil_user.php">
      ...
      ?>
       ...
       <li class="nav-item <?php if ($page == "Penilaian") {
          ...
          <a class="nav-link" href="list-penilaian-userr.php">
            <i class="fas fa-fw fa-edit"></i>
            <span>Data Penilaian</span></a>
        </li>
        ...
        <li class="nav-item <?php if ($page == "Hasil") {
          ...
          <a class="nav-link" href="hasil_user2.php">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Data Hasil Akhir</span></a>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn text-orange d-md-none rounded-circle mr-3">
